...
const CreatePost = () => {
  ...
  return (
    <div>
        <Navbar/>
        <div className='px-6 md:px-[200px] mt-8 p-4'>
        ...
        <form className='w-full flex flex-col space-y-4 md:space-y-8 mt-4'>
          ...
          <textarea onChange={(e)=>setDesc(e.target.value)} rows={12} cols={30} className='px-4 py-2 outline-none' placeholder='Enter post description'/>
